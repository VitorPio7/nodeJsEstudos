...
/*handler com a funcao de enviar ao usuário um JWT */
...
exports.resetPassword = catchAsync(async (req, res, next) => {
  ...
  // 2) set o novo usuário, desde que ha um usuário e o token nao expirou;
  if (!user) {
  ...
  user.passwordResetToken = undefined;
  user.passwordResetExpires = undefined;
  await user.save(); /*a validação so roda no save */
...
/*Nos criaremos  um handler para quando o usuário estiver logado e quiser mudar a senha*/
